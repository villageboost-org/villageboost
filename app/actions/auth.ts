...
// This is the shape of the state returned from each action.
// `errors` holds field-level validation messages.
// `message` holds a general success or error message.
...
export async function updatePassword(
  ...
  if (error) {
    return { message: 'Failed to update password. Your reset link may have expired.' }
  }
